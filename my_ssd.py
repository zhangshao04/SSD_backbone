...
class MYSSD(nn.Module):
    def __init__(self, cfg):
        ...
        self.conv10_2_extra = nn.ConvTranspose2d(256,512,kernel_size=3,stride=19,padding=2,output_padding=1)
    ...
    def forward(self, x):
        ...
        for k, v in enumerate(self.extras):
            ...
            if k == 5:
                ...
                conv_10_2 = self.l2_norm(conv_10_2)
                conv_10_2 = F.relu(conv_10_2,inplace=True)
                con4_3_new = s - conv_10_2
...
@registry.BACKBONES.register('MYSSD')
